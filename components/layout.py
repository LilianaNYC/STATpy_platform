...
const TAB_LABELS_FOR_PDF = {
  overview:     'Overview',
  governance:   'Business_Governance',
  schema:       'Schema',
  completeness: 'Completeness',
  rules:        'Business_Rules',
  population:   'Population',
  drift:        'Distribution_Drift',
  scorecard:    'P24_vs_P25_Scorecard',
};
