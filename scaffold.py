...
DIRS = [
    ...
    "features/monitoring/ui/pages",
    "features/monitoring/ui/views",
    "features/monitoring/callbacks",
    "features/monitoring/services",
    "features/monitoring/tests",
    "features/saas",
    "features/saas/domain",
    "features/saas/services",
    "features/saas/ui",
    "features/saas/ui/pages",
    "features/saas/ui/views",
    "features/saas/callbacks",
    "features/saas/tests",
    "source_data",
    "tests",
]
