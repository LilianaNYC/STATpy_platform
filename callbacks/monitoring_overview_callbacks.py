"""Callbacks for the dashboard overview page."""
...
from ..data.overview import overview_filter_options
from ..pages import monitoring_overview_layout as layout
...
def register_callbacks(app, data: dict, overview_rows: list[dict]) -> None:
    @app.callback(
