"""Layout for the EAD Performance page (placeholder).

No EAD data source has been wired up yet, so this page only renders a top
...
def page_layout() -> list:
    """Top bar + placeholder content for the EAD Performance page."""
    return [
        html.Div(
            className="top-bar",
            children=[
                html.Div(
                    style={"flex": "1"},
                    children=[
                        html.Div("EAD Performance", className="monitoring-dashboard-title"),
                    ],
                ),
            ],
        ),
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(
                            "This page is reserved for the EAD Performance dashboard. Its layout, "
