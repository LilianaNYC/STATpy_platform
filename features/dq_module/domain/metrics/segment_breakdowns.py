...
from ..grading import detect_count_anomalies  # canonical home; re-exported here
...
# detect_count_anomalies now lives in domain/grading.py — imported at the top
# of this module and re-exported so existing callers (services/processor.py)
