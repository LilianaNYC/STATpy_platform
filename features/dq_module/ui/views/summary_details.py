...
from ..common import (
    ...
    simple_table, td, detect_count_anomalies,
)
...
# detect_count_anomalies is imported from common above (re-exported from
# domain/grading.py) — this view holds no business logic of its own.
